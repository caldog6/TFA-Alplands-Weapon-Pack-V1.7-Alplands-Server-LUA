...
SWEP.Purpose				= "Ideal for point-blank 'fuck you' attacks. Doesn't do much past 30cm." --Purpose Tooltip
...
SWEP.PrintName				= "IZH-43 (Sawn-off)"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM_Burst = 99999999
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_doublebarrel_sawnoff.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_doublebarrel_sawnoff.mdl" -- Weapon world model path
