...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_AK47.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_AK47.2") -- This is the sound of the weapon, when silenced.
...
--Movespeed
SWEP.MoveSpeed = 0.900 --Multiply the player's movespeed by this.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/akpack/c_akm.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/akpack/w_akm.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.915, -8, 1.08)
SWEP.IronSightsAng = Vector(-0.2, 0.0, 0)

SWEP.IronSightsPos_GL = Vector(-1.35, -4.61, 1.1)
SWEP.IronSightsAng_GL = Vector(1.05,-0.01,0)

SWEP.IronSightsPos_Kobra = Vector(-2.91, -3, -0.78)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.91, -1, -0.545)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.91, -1, -0.545)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.91, -2.5, -0.55)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 =  Vector(-2.91, -0.5, -0.905)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-2.847, -2, -0.435)
...
SWEP.VElements = {
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/akpack/upgrades/a_woodgrips_akm.mdl", bone = "A_Foregrips", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
