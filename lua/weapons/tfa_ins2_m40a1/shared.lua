...
--Range Related
SWEP.Primary.Range = 63500 * 4 / 3-- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.IronSightsPos_Kobra = Vector(-3.1, -1.5, 0.4)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech =  Vector(-3.1, -1.5, 0.25)
...
SWEP.IronSightsPos_C79 = Vector(-3.091, -2.5, -0.022)
...
SWEP.IronSightsPos_MX4 = Vector(-3.117, -3.2, 0.334)
...
SWEP.VElements = {
	...
	["scope_mx4"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_m40_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90.7, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
...
SWEP.Attachments = {
	[6] = { offset = { 0, 0 }, atts = { "ins2_si_mx4" }, order = 2, sel = 1 },
}
...
SWEP.ScopeDistanceMin_Mosin = 9
SWEP.ScopeDistanceRange_Mosin = 10
