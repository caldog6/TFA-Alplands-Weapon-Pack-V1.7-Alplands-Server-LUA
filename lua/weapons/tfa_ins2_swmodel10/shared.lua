...
SWEP.PrintName				= "Model 10"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 1				-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos				= 73			-- Position in the slot
SWEP.AutoSwitchTo			= true		-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom			= true		-- Auto switch from if you pick up a better weapon
SWEP.Weight				= 30			-- This controls how "good" the weapon is for autopickup.
SWEP.Type = "Revolver, .45 Caliber"
...
SWEP.Primary.Knockback = nil --Autodetectedd if nil; this is the velocity kickback
...
SWEP.Primary.DryFireDelay = .4 --How long you have to wait after firing your last shot before a dryfire animation can play.  Leave nil for full empty attack length.  Can also use SWEP.StatusLength[ ACT_VM_BLABLA ]
...
--Recoil Related
SWEP.Primary.KickUp = .95-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = .38 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = .14 -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor = .85 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
...
--Range Related
SWEP.Primary.Range = 0.15 * (3280.84 * 16) -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = -1 -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
SWEP.MaxPenetrationCounter = 3 --The maximum number of ricochets.  To prevent stack overflows.
--Misc
SWEP.IronRecoilMultiplier = 0.765 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
SWEP.CrouchAccuracyMultiplier = 0.45 --Less is more.  Accuracy * 0.5 = Twice as accurate, Accuracy * 0.1 = Ten times as accurate
--Movespeed
...
SWEP.VMPos = Vector(-.2, -1.1, -.25) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.ShellTime = .575 -- For shotguns, how long it takes to insert a shell.
...
SWEP.SequenceLengthOverride = {[ACT_VM_DRAW_DEPLOYED] = 2,
[ACT_SHOTGUN_RELOAD_START] = 2.25,
...
[ACT_SHOTGUN_RELOAD_START] = 1.25,
[ACT_SHOTGUN_RELOAD_FINISH] = 1.25,
[ACT_VM_RELOAD_DEPLOYED] = 1.1}
...
SWEP.StatusLengthOverride = {
	...
	[ACT_VM_RELOAD_DEPLOYED] = 90 / 33.5,
}
