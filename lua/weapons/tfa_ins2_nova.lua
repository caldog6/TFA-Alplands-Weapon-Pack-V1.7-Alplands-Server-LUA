...
SWEP.Primary.Ammo = "12 Gauge" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
SWEP.IronSightsPos_2XRDS = Vector(-2.044, -4, -0.396)
SWEP.IronSightsAng_2XRDS = Vector(0.0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.044, -3, -0.815)
SWEP.IronSightsAng_C79 = Vector(0.0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-1.984, -3, -0.055)
SWEP.IronSightsAng_PO4X = Vector(0.0, 0, 0)
--[[INSPECTION]]--
...
SWEP.VElements = {
	...
	["scope_2xrds_lens"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Lense_RT", rel = "scope_2xrds", pos = Vector(0, 0, -0.015), angle = Angle(-90, 0, -90), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	...
	["scope_c79_lens"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Lense_RT", rel = "scope_c79", pos = Vector(0, -0.015, 0), angle = Angle(0, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	...
	["scope_po4x_lens"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Lense_RT", rel = "scope_po4x", pos = Vector(0, 0, -0.015), angle = Angle(-90, 0, -90), size = Vector(0.3, 0.3, 0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec2.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
...
SWEP.WElements = {
	...
	["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_eotech.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "ref", pos = Vector(8.562, 0, -10.452), angle = Angle(0, 0, 0), size = Vector(0.79, 0.79, 0.79), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
...
SWEP.ScopeOverlayTransforms_2XRDS = { 0, -0.36 }
SWEP.ScopeDistanceMin_2XRDS = 8
SWEP.ScopeDistanceRange_2XRDS = 4

SWEP.RTAttachment_C79 = 8
SWEP.ScopeOverlayTransforms_C79 = { 0, -0.412 }
SWEP.ScopeDistanceMin_C79 = 8.5
SWEP.ScopeDistanceRange_C79 = 4

SWEP.RTAttachment_PO4X = 8
SWEP.ScopeOverlayTransforms_PO4X = {
	-0.007,-0.25
}
SWEP.ScopeDistanceMin_PO4X = 8.5
SWEP.ScopeDistanceRange_PO4X = 4
