...
SWEP.Manufacturer = "Brazil" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "Matsilagi" --Author Tooltip
...
SWEP.PrintName				= "Pipe Pistol"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_PYRO_PIPEGUN.1")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("TFA_PYRO_PIPEGUN.1")				-- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM_Burst				= 1250					-- RPM for burst fire, overrides semi.  This is in Rounds Per Minute / RPM
...
SWEP.Primary.StaticRecoilFactor = 1.6 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.Primary.SpreadIncrement = 4.5 --What percentage of the modifier is added on, per shot.
SWEP.Primary.SpreadRecovery = 20 --How much the spread recovers, per second.

--Range Related
SWEP.Primary.Range = 273*3*16 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.IronSightTime = 0.2 --The time to enter ironsights/exit it.
...
SWEP.ViewModel			= "models/pyromancer/c_pyromancer_pipegun.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/pyromancer/w_pyromancer_pipegun.mdl" -- Weapon world model path
...
SWEP.ShellTime			= 1.35 -- For shotguns, how long it takes to insert a shell.

--[[SPRINTING]]--

SWEP.RunSightsPos = Vector(0, 0, 0)
SWEP.RunSightsAng = Vector(-11.869, 5.129, -5.056)
--[[IRONSIGHTS]]--
...
--SWEP.IronSightsPos = Vector(-3.18, -4.694, 0.192)
--SWEP.IronSightsAng = Vector(0, 0, 0) - SWEP.VMAng

SWEP.IronSightsPos = Vector(-3.45, 4, 1.5)
...
SWEP.BlowbackBoneMods = {
	["bolt"] = { scale = Vector(1, 1, 1), pos = Vector(-0.75, 0, 0), angle = Angle(0, 0, 0) }
}
