...
SWEP.PrintName				= "Vz. 61 Škorpion"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_VZ61.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_VZ61.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.SpreadIncrement = 0.70 --What percentage of the modifier is added on, per shot.  Example val: 1/3.5
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_vz61.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_vz61.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.096, -2.5, 0.44)
SWEP.IronSightsAng = Vector(0, 0, 0)

--[[INSPECTION]]--
SWEP.InspectPos = Vector(5, -2.619, -2.787)
