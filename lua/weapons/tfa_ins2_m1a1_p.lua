...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.M1A1.PARA.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_pyro_m1a1para.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_m1a1para.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.475, -3.5, 1.18)
SWEP.IronSightsAng = Vector(0.17, 0, 0)
