...
SWEP.Manufacturer = "Izhevsk Mechanical Plant" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "Commando" --Author Tooltip
SWEP.Contact				= "http://steamcommunity.com/profiles/76561198161775645" --Contact Info Tooltip
SWEP.Purpose				= "Classic standard military and police force sidearm, used for close quarters combat." --Purpose Tooltip
...
SWEP.PrintName				= "PM Makarov"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 1				-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos				= 73			-- Position in the slot
SWEP.AutoSwitchTo			= true		-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom			= true		-- Auto switch from if you pick up a better weapon
SWEP.Weight				= 30			-- This controls how "good" the weapon is for autopickup.
SWEP.Type = "Russian 9×18mm Semi Automatic Pistol"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_PM.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_PM.2") -- This is the sound of the weapon, when silenced.
...
SWEP.NZPaPName			= "PM Mak-a-WWE-Raw"
...
SWEP.IronSightsPos = Vector(-2.085, 0.863, 0.44)
...
SWEP.VElements = {
	...
	["mag"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_alp_magazine_pm_8.mdl", bone = "Magazine", rel = "", pos = Vector(0.4, 0, 0.8), angle = Angle(0, 0, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
	["mag_drum"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/v_pmdrum.mdl", bone = "Magazine", rel = "", pos = Vector(1.4, -10.8, -0.45), angle = Angle(0, 270, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
...
["ref"] = { type = "Model", model = SWEP.WorldModel, bone = "oof", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },	["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_eotech.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "ref", pos = Vector(8.562, 0, -10.452), angle = Angle(0, 0, 0), size = Vector(0.79, 0.79, 0.79), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	...
	["mag"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_alp_magazine_makarov_8.mdl", bone = "W_PIS_MAGAZINE", rel = "ref", pos = Vector(0.4, 0, 0.8), angle = Angle(0, 0, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
	["mag_ext"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_magazine_makarov_15.mdl", bone = "W_PIS_MAGAZINE", rel = "ref", pos = Vector(0.4, 0, 0.8), angle = Angle(0, 0, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["mag_drum"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_pmdrum.mdl", bone = "W_PIS_MAGAZINE", rel = "ref", pos = Vector(1.4, -10.8, -0.45), angle = Angle(0, 270, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}
...
SWEP.RunSightsPos = Vector(1, -7, -10)
