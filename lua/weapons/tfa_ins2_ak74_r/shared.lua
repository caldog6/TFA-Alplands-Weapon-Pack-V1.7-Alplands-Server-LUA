...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_AK74.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_AK74.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.KickHorizontal = 0.275 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/akpack/c_ak74.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 56		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(0.5,2,-0.5) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/akpack/w_ak74.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.912, -8, 1.07)
SWEP.IronSightsAng = Vector(-0.2, 0.0, 0)

SWEP.IronSightsPos_GL = Vector(-1.35, -4.61, 1.1)
SWEP.IronSightsAng_GL = Vector(1.05,-0.01,0)

SWEP.IronSightsPos_Kobra = Vector(-2.9, -3, -0.78)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.9, -1, -0.54)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.9, -1, -0.545)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.898, -2.5, -0.55)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 =  Vector(-2.898, -0.5, -0.905)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-2.835, -2, -0.435)
...
SWEP.ViewModelBoneMods = {
	["A_Foregrips"] = { scale = Vector(0.8,0.8,0.8), pos = Vector(0, 0, 0), angle = Angle(0,0,0) }
}
SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(0.7,0.7,0.7), pos = Vector(-1, 0, 0), angle = Angle(0,0,0) },
	["ATTACH_ModKit"] = { scale = Vector(0.7,0.7,0.7), pos = Vector(0, 0, 0), angle = Angle(0,0,0) }
}

SWEP.VElements = {
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/akpack/upgrades/a_modkit_06.mdl", bone = "A_GL", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["scope_po4x"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_po4x24_m.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/akpack/upgrades/a_suppressor_ak.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/akpack/upgrades/a_woodgrips_ak74.mdl", bone = "A_Foregrips", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
...
SWEP.WElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/akpack/upgrades/w_sil_ins1.mdl", bone = "ATTACH_Muzzle", rel = "ref", pos = Vector(-3, 0.1, 14), angle = Angle(0, 0, 0), size = Vector(0.699, 0.699, 0.699), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
