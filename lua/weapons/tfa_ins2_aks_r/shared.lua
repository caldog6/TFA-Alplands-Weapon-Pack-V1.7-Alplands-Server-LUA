...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_AKS.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_AKS.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/akpack/c_aks74u.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/akpack/w_aks74u.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.91, -3, 0.675)
SWEP.IronSightsAng = Vector(-0.3, -0.025, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.91, -1, -0.943)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.91, -1, -0.71)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.91, -1, -0.71)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.91, -2.5, -0.71)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 =  Vector(-2.91, -0.5, -1.065)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-2.847, -1, -0.6)
...
SWEP.ViewModelBoneMods = {
	["A_Foregrip"] = { scale = Vector(1,1,1), pos = Vector(0, 0, 0), angle = Angle(0,0,0) }
}
...
SWEP.VElements = {
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/akpack/upgrades/a_modkit_07.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/akpack/upgrades/a_woodgrips_aks74u.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
