...
SWEP.PrintName				= "Scrap SMG"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_PYRO_SSMG.1")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("TFA_PYRO_SSMG.1")				-- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM				= 555					-- This is in Rounds Per Minute / RPM
...
SWEP.JumpAccuracyMultiplier=1.7--Less is more.  Accuracy * 2 = Half as accurate.  Accuracy * 5 = 1/5 as accurate
SWEP.WalkAccuracyMultiplier=1.1--Less is more.  Accuracy * 2 = Half as accurate.  Accuracy * 5 = 1/5 as accurate
...
SWEP.ViewModel			= "models/pyromancer/c_pyromancer_scrap_smg.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/pyromancer/w_pyromancer_scrap_smg.mdl" -- Weapon world model path
...
--SWEP.IronSightsPos = Vector(-1.5, 0.12, -0.04)
--SWEP.IronSightsAng = Vector(0.004, 2.714, -0.002)
SWEP.IronSightsPos = Vector(-2.41, 0, 0.91)
SWEP.IronSightsAng = Vector(0, 3.200, 0.071)
...
SWEP.SprintBobMult=1.2 -- More is more bobbing, proportionally.  This is multiplication, not addition.  You want to make this > 1 probably for sprinting.
...
SWEP.BlowbackBoneMods = {
	["Slide"] = { scale = Vector(1, 1, 1), pos = Vector(0, -2, 0), angle = Angle(0, 0, 0) }
}
