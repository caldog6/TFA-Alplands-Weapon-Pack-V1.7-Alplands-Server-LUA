...
SWEP.Primary.Ammo = "4.6x30mm" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_alp_mp7.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_alp_mp7.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.17, 0, 0.67)
SWEP.IronSightsAng = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.17, -4, 0)
...
SWEP.ViewModelBoneMods = {
	["A_Suppressor"] = { scale = Vector(attscale * .75, attscale * .75, attscale * .75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	...
	["A_LaserFlashlight"] = { scale = Vector(attscale, attscale, attscale), pos = Vector(0, 0, 0.55), angle = Angle(0, 0, 0) },
}

SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(.65, .65, .65), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
...
SWEP.Attachments = {
	[9] = { offset = { 0, 0 }, atts = { "ins2_si_eotech" }, sel = 1, order = 2 }
}
...
SWEP.ScopeOverlayTransforms_2XRDS = { 0, -0.455 }
SWEP.ScopeDistanceRange_2XRDS = 8
SWEP.ScopeDistanceMin_2XRDS = 6

SWEP.RTAttachment_C79 = 7
SWEP.ScopeOverlayTransforms_C79 = { 0, -0.453 }
SWEP.ScopeDistanceRange_C79 = 8
SWEP.ScopeDistanceMin_C79 = 7

SWEP.RTAttachment_PO4X = 7
SWEP.ScopeOverlayTransforms_PO4X = { -0.01, -0.324 }
SWEP.ScopeDistanceRange_PO4X = 9
SWEP.ScopeDistanceMin_PO4X = 7
