...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(2, -1.5, 0.5) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-13, 25, 0)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.WElements = {
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/c_spas12_bri_supp.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.3,-1.3,-1.2), angle = Angle(-10, -2, 0), size = Vector(0.8 / 1.3, 0.8 / 1.3, 0.8 / 1.3 ), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
SWEP.Attachments = {
}
