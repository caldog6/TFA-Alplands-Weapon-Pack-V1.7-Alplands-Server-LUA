...
SWEP.Purpose				= "Double trouble will pop your bubble, ideal for any type of hillbilly!" --Purpose Tooltip
...
SWEP.PrintName				= "IZH-43"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 3			-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos				= 73			-- Position in the slot
SWEP.AutoSwitchTo			= true		-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom			= true		-- Auto switch from if you pick up a better weapon
SWEP.Weight				= 30			-- This controls how "good" the weapon is for autopickup.
SWEP.Type = "Russian 12 Gauge Break Action Shotgun"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_DOUBLEBARREL.1") -- This is the sound of the weapon, when you shoot.
...
--Range Related
SWEP.Primary.Range = 0.035 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_doublebarrel.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_doublebarrel.mdl" -- Weapon world model path
...
SWEP.VElements = {
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_12ga.mdl", bone = "A_Muzzle", rel = "", pos = Vector(-73, -4.7, 2.8), angle = Angle(0, 0, 0), size = Vector(1.5, 1.8, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = false, active = false },
}
