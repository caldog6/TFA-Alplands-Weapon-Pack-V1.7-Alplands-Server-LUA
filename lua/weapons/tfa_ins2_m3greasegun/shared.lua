...
SWEP.Manufacturer = "General Motors" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "pyro" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "A slow firing, cheap to produce; .45 ACP spewing pile of horseshit." --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= "M3 Submachine Gun"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 2			-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos				= 73			-- Position in the slot
SWEP.AutoSwitchTo			= true		-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom			= true		-- Auto switch from if you pick up a better weapon
SWEP.Weight				= 30			-- This controls how "good" the weapon is for autopickup.
SWEP.Type = "American Mass-Produced .45 ACP Submachine Gun"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_M3GREASEGUN.1")
...
SWEP.Primary.KickDown = 0.355 -- This is the maximum downwards recoil (skeet)
...
--Range Related
SWEP.Primary.Range = 200 * 48 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_m3greasegun.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_m3greasegun.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.505, -1.5, 1.315)
...
SWEP.VElements = {
	["stock"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_stock_extended_m3.mdl", bone = "A_Stock", rel = "", pos = Vector(2, 2, 2), angle = Angle(0, 0, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
}
